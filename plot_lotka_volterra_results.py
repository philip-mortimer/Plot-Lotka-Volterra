...
def plot_changes_over_time(sub_plot, results):
    sub_plot.plot(
...
def plot_predators_vs_prey(sub_plot, results):
    sub_plot.plot(
...
def plot_lotka_volterra_results(results):
    """
    results.time_series:     
        series of time values to be used as the 
        changes over time sub-plot's x-axis values
                                     
    results.predator_series.values: 
        series of predator poplulation densities
        
    results.prey_series.values:     
        series of prey poplulation densities
        
    results.predator_series.label,
    results.prey_series.label:
        labels (e.g. 'lions', 'antelope') which 
